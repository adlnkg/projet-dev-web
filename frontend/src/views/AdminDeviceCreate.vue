...
const {
  ...
  createFormEndpoint: '/api/devices/create-form',
  submitEndpoint: '/api/devices',
  redirectTo: { path: '/recherche', query: { category: 'device' } },
  successMessage: 'Objet connecté créé.',
...
<template>
  <div class="page-container">
    ...
    <EntityForm
      ...
      v-model="formValues"
      :fields="activeFields"
      title="Nouvel objet connecté"
      description="Les champs spécifiques dépendent du type d'appareil sélectionné."
      submit-label="Créer"
      cancel-label="Retour"
      :loading="submitting"
      :error="submitError"
